...
export class AuthController {
  ...
  // This route is guarded with session
  ...
  // This route is guard with session, and role of admin
  ...
  // This route is guarded with jwt, client has to attach jwt token to this route
  @UseGuards(JwtAuthGuard) // Ensure the user is authenticated to access their route
  @Get('jwt-guarded')
